    ...
    return (
        <header className=" flex justify-between">
          <Link to={'/'} className="logo flex items-center gap-1">
             ...
             <span className="font-bold text-xl text-white">BookResto</span>
    
          </Link>
          <div className="flex gradient gap-2  rounded-full py-2 px-4">
          ...
          <Link to={user?'/account':'/login'} className="flex gradient items-center gap-2  rounded-full py-2 px-4 ">
